...
## Main files
**Note:(Current files that build the website are in folder elephantatthecon/public/eatc/src)**
...
cssc_script_test.html inside “data” folder -- this is a helper html file that lets you c
